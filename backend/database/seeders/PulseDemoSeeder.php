    ...
    private function seedCategories(): array
    {
        $items = [
            ...
            [
                ...
                'cover_image' => '/images/events/tech-future.avif',
            ],
            [
                'name' => 'Food',
                'slug' => 'food',
                'description' => 'Pop-ups, tastings and weekends built around good food.',
                'cover_image' => '/images/events/urban-food.jpg',
            ],
            [
                'name' => 'Art',
                'slug' => 'art',
            ...
            [
                'name' => 'Sports',
                'slug' => 'sports',
                'description' => 'Movement, competition and active experiences.',
                'cover_image' => '/images/events/sunset-run.jpg',
            ],
            [
                'name' => 'Workshops',
                'slug' => 'workshops',
                'description' => 'Learn something new and make something yourself.',
                'cover_image' => '/images/events/ceramic-sunday.jpg',
            ],
            [
                'name' => 'Nightlife',
                'slug' => 'nightlife',
                'description' => 'Late nights, music and places worth discovering.',
                'cover_image' => '/images/events/wine-and-vinyl.jpeg',
            ],
            [
                'name' => 'Comedy',
                'slug' => 'comedy',
                'description' => 'Live comedy and very questionable decisions.',
...
TEXT,
                ...
                'cover_image' => '/images/events/electric-nights.jpg',
                ...
                'is_featured' => true,
                'gallery' => [
                    '/images/events/electric-nights.jpg',
                    '/images/events/electric-nights-2.jpg',
                    '/images/events/electric-nights-3.jpg',
                ],
            ],
            [
            ...
            [
                ...
                'organizer' => 'pulse-culture',
                'cover_image' => '/images/events/makers-market.jpg',
